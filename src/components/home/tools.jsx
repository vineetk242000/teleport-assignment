  ...
  return (
    <div className="container py-12 flex flex-column justify-center">
      <div className="mx-auto w-full  px-4 lg:px-8 lg:w-full">
        <div className="mx-auto pb-4 lg:text-start border-b-default border-b-fill lg:border-none">
