...
export default function Newsletter() {
  ...
  return (
    <div className="container pb-12 flex flex-column justify-center items-center lg:px-8">
      <div className="mx-auto  px-8 md:px-0  md:py-8 md:w-full md:border-default md:border-fill md:rounded-md md:flex">
        ...
        <div className="w-full md:w-2/3">
          <div className=" pb-6 md:pb-0 mx-auto  w-full lg:inline-block">
          ...
          <div className="lg:flex">
            ...
            <button
              className={`${email.length > 3 ? "bg-primary" : "bg-fill"} w-full py-2 my-2 md:mb-3 md:mt-4 rounded-lg lg:w-1/6 md:ml-4`}
            >
