...
const Sidebar = () => {
  return (
    <div className="hidden lg:flex min-h-screen  flex-col flex-auto flex-shrink-0 antialiased bg-white text-gray-800">
      <div className="px-2 fixed flex flex-col top-0 left-0 w-2/12 bg-white h-full border-r border-r-default border-r-fill pt-16 z-10">
        <div className="overflow-y-auto overflow-x-hidden flex-grow">
          <ul className="flex flex-col py-4 space-y-1">
            <li className="border-b-default border-b-fill px-2 py-2">
              <a
                href="#"
                className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-fill text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6  rounded-md"
              >
                <span className="inline-flex justify-center items-center">
                  <UserCircleIcon className="w-5 h-5 ml-4" />
                </span>
