...
export const Header = () => {
  return (
    <nav className="bg-white  py-4 px-6 lg:px-8 md:py-4 flex justify-between items-center w-full border-b-default border-b-fill fixed top-0 left-0 z-20 opacity-100 ">
      <div className="container  mx-auto flex items-center w-1/2 h-full ">
        <Bars3Icon className="w-5 mr-4" />
